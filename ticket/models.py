...
class Ticket(models.Model):
    """Класс тикетов
    """
    user = models.ForeignKey(User, verbose_name='Пользоватеь', on_delete=models.CASCADE)
    category = models.ForeignKey(CategoryTicket, verbose_name='Категория', on_delete=models.CASCADE)
